  ...
  <div class="main">
    <a-form class="user-layout-login" ref="formLogin" :autoFormCreate="(form)=>{this.form = form}" id="formLogin">
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          ...
          <a-form-item
            ...
            :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入用户名' }, { validator: this.handleUsernameOrEmail }], validateTrigger: 'change'}">
            <a-input size="large" type="text" placeholder="用户名 / username">
      ...
      <a-form-item>
        ...
        <router-link :to="{ name: 'recover', params: { user: 'aaa'} }" class="forge-password" style="float: right;padding-right: 20px;">
          忘记密码
        </router-link>
      </a-form-item>
